...
class Calendar extends React.Component {
  ...
  startWatch(walkId) {
    ...
    var debouncedProcessGeoResult = _.debounce(this.processGeoResult.bind(this, walkId), 10000);

    var watchId = window.navigator.geolocation.watchPosition(debouncedProcessGeoResult, this.handleGeoError, {
