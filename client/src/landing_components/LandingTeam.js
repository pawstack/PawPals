...
=======
            <div className="col-md-6">
              ...
              <div className='icon-title'>
                Young Lu
                <span className='contact-icon-span'><a href="https://www.linkedin.com/in/yanglu3/"><img src="https://cdn0.iconfinder.com/data/icons/social-flat-rounded-rects/512/linkedin-256.png" className="contact-icon-img"></img></a></span>
                <span className='contact-icon-span'><a href="https://github.com/youngyanglu"><img src="https://mapbox.github.io/mapbox-gl-native/macos/0.5.0/img/github.svg" className="contact-icon-img"></img></a></span>
>>>>>>> formatted team page and added linkedin and github icons
              </div>
              <div className='icon-text'>
                Calender system to easily schedule and book walks.
              </div>
